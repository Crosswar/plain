          ...
          <div class="container">
            <div class="row">
              <div class="col-md-8 col-md-offset-2">
                <h3 class="arrow">A Creative Portfolio Template</h3>
        ...
        <section class="team text-center section-padding" id="team">
          <div class="container">
            <div class="row">
              <div class="col-md-12">
                <h3 class="arrow">We're a team that adore what we do</h3>
              </div>
            </div>
          </div>
        </section>
        <section class="subscribe text-center">
          <div class="container">
            <h1><i class="fa fa-paper-plane"></i><span>Subscribe to receive articles every week</span></h1>
            <form action="#">
        ...
        <section class="dark-bg text-center section-padding contact-wrap" id="contact">
          ...
          <div class="container">
            <div class="row">
              <div class="col-md-12">
                <h3 class="arrow">Need Help? Feel free to contact us!</h1>
              </div>
            </div>
            <div class="row contact-details">
              ...
              <div class="col-md-4">
                <div class="light-box box-hover">
                  ...
                  <p><a href="#"><strong>contact@plainhealing.org</strong></a></p>
                </div>
              </div>
            </div>
            <div class="row">
