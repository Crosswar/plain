...
<head>
    ...
    <!-- Theme CSS -->
    <link rel="stylesheet" type="text/css" href="<?= base_url()?>public/css/blog/blog.css" >

    <!-- Theme JS -->
    <script src="<?= base_url()?>public/js/blog.js"></script>
    <!-- Custom Fonts -->
    <link href="<?= base_url()?>public/css/shared/font-awesome.css" rel="stylesheet" type="text/css">
